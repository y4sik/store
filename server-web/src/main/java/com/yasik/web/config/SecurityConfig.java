...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.DELETE, "/api/admin/addresses/*").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/api/orders").hasRole("CUSTOMER")
                .antMatchers(HttpMethod.POST, "/api/orders").hasRole("CUSTOMER")
                .antMatchers(HttpMethod.GET, "/api/customer_orders").hasRole("CUSTOMER")
                .antMatchers(HttpMethod.GET, "/api/product_orders/*").hasRole("CUSTOMER")
                .antMatchers(HttpMethod.GET, "/api/moderator/customer_orders/*").hasRole("MODERATOR")
                .antMatchers(HttpMethod.GET, "/api/moderator/product_orders/*").hasRole("MODERATOR")
                .antMatchers(HttpMethod.GET, "/api/feedbacks").hasRole("CUSTOMER")
                .antMatchers(HttpMethod.POST, "/api/feedbacks/*").hasRole("CUSTOMER")
                .antMatchers(HttpMethod.GET, "/api/feedbacks/*").hasRole("CUSTOMER")
                .antMatchers(HttpMethod.DELETE, "/api/feedbacks/*").hasRole("CUSTOMER")
                .antMatchers(HttpMethod.GET, "/api/moderator/feedbacks/*").hasRole("MODERATOR")
                .antMatchers(HttpMethod.DELETE, "/api/moderator/feedbacks/*").hasRole("MODERATOR")
                .and()
